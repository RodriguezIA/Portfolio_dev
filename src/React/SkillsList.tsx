          ...
          {categoryKeys.map((key) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-1.5 px-3 py-3 rounded-2xl border transition-all duration-200 text-xs font-semibold flex-1 justify-center cursor-pointer
                  ${isSelected
                    ? "bg-[var(--sec)] border-[var(--sec)] text-[var(--background)]"
                    : "bg-[#1414149c] border-[var(--white-icon-tr)] text-[var(--white-icon)] hover:border-[var(--sec)] hover:text-white"
                  }`}
              >
                <span className={isSelected ? "text-[var(--background)]" : "text-[var(--sec)]"}>
                  {CategoryIcons[key]}
                </span>
                {shortLabels[key]}
              </button>
